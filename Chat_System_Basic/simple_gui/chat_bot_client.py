...
class ChatBotClient():
    ...
    def __init__(self, name="3po", model="gemma3", host='http://localhost:11434', headers={'x-some-header': 'some-value'}):
        ...
        #默认人格
        self.set_personality("normal")

    # 🎭 设置人格
    def set_personality(self, mode):
        personalities = {
            "normal": "你是一个礼貌而友好的 AI 助手，语言自然。",
            "catgirl": "你是一个可爱撒娇的猫娘，说话要带喵～语气萌萌的。",
            "professor": "你是一位严肃、有逻辑、有知识深度的大学教授，解释问题要条理清晰。",
            "joker": "你是一个喜欢讲冷笑话的机器人，说话幽默，有时无厘头。",
            "tsundere": "你是一个傲娇 AI,嘴硬心软,说话带点毒舌但其实关心用户。"
        }
        # 重置对话，同时设置 system prompt
        self.messages = [
            {"role": "system", "content": personalities[mode]}
        ]
